...
R12: If you call `transfer_to_human_agents`, or the customer says they are done, your VERY NEXT action is `end_conversation` or the stop token - no wrap-up sentence first. A missing stop signal means the case is scored as unresolved even when you did everything else right.
